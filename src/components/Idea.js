        ...
        return (
            <div className="container" align="center"> <br/>
                ...
                <div className="row2 row-cols-22">
                    <div> 
                        <i className="far fa-thumbs-up fa-2x" style={{color: '#ffc107'}}></i>&nbsp;&nbsp; {idea.attributes.likes} &nbsp;&nbsp;&nbsp;&nbsp;
                        <i className="fas fa-comments fa-2x" style={{color: '#ffc107'}}></i>&nbsp;&nbsp; {idea.relationships.comments.data.length} 
                    </div>
                    <div align="center">
